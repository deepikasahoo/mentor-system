...
def registration():
    ...
    if len(t1.get())==0:
        ...
        Aadhar_no=t7.get();
        genderselected;
        Blood_group=bloodgroup_list.get();
        State=state_list.get();

        sql="insert into facultyregform values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)";
        val=(Employee_id,Full_Name,User_id,Password,Mobile_no,Email_id,Aadhar_no,genderselected,Blood_group,State)
...
l3=Label(win,text="Faculty Registration form",fg="black",font=("calibri",15,"bold"))
l3.place(x=140,y=100)




l4=Label(win,text="Employeeid:",fg="black",font=("calibri",15,"bold"))
l4.place(x=50,y=150)
...
register_button=Button(win,text="Submit",command=registration,fg="black",bg="lightblue",font=("calibri",15,"bold"))
