...
def registration():
    ...
    if len(t1.get())==0:
        ...
        sql="insert into prinregform values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)";
        val=(Empid,Full_Name,Userid,Password,Mobileno,Emailid,Aadharno,genderselected,Blood_group,State)
...
l3=Label(win,text="Principal Registration form",fg="black",font=("calibri",15,"bold"))
l3.place(x=140,y=100)




l4=Label(win,text="Empid:",fg="black",font=("calibri",15,"bold"))
l4.place(x=50,y=150)
