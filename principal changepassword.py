...
def Changepassword():
    ...
    if len(t1.get())==0:
       ...
       t1.focus_set()
        ...
        cur=conn.cursor()
        cur.execute("select * from prinregform where Userid=%s and Password=%s",(t1.get(),t2.get()))
...
l3=Label(win,text="CHANGE PASSWORD(PRINCIPAL)",fg="black",bg="#B2A59B",font=("calibri",18,"bold"))
