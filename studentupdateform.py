...
l3=Label(win,text="STUDENT UPDATE FORM",fg="black",font=("calibri",15,"bold"))
...
register_button=Button(win,text="Update",command=registration,fg="black",bg="lightblue",font=("calibri",15,"bold"))
register_button.place(x=150,y=470)
clearall_button=Button(win,text="Cancel",command=Cancel,fg="black",bg="lightblue",font=("calibri",15,"bold"))
...
close_button=Button(win,text="X",fg="black",command=Close,bg="red",font=("calibri",15,"bold"))
